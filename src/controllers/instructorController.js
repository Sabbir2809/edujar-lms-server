...
// router.post("/create-Instructors",upload.single("image"), instructorsController.createInstructors);
// router.get("/all-Instructors", instructorsController.getAllInstructors);